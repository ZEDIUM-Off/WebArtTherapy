...
var require_camera_utils = __commonJS({
  "node_modules/@mediapipe/camera_utils/camera_utils.js"(exports) {
    (function() {
      ...
      var q = typeof Object.defineProperties == "function" ? Object.defineProperty : function(a, b, e) {
      ...
      function v(a, b) {
        if (b)
          a: {
            ...
            f = e[a];
            b = b(f);
            b != f && b != null && q(e, a, { configurable: true, writable: true, value: b });
          }
      }
      v("Symbol", function(a) {
        function b(l) {
      ...
      v("Symbol.iterator", function(a) {
        ...
        for (var b = "Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array".split(" "), e = 0; e < b.length; e++) {
          var f = u[b[e]];
          typeof f === "function" && typeof f.prototype[a] != "function" && q(f.prototype, a, { configurable: true, writable: true, value: function() {
            return w(n(this));
          } });
        }
        return a;
      ...
      v("Promise", function(a) {
        ...
        b.prototype.then = function(c, d) {
          function g(p, r) {
            return typeof p == "function" ? function(E) {
              try {
                k(p(E));
              } catch (F) {
                m(F);
...
// dep:@mediapipe_camera_utils
var mediapipe_camera_utils_default = require_camera_utils();
export {
  mediapipe_camera_utils_default as default
};
