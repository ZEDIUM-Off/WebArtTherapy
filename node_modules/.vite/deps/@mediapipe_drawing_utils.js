...
var require_drawing_utils = __commonJS({
  "node_modules/@mediapipe/drawing_utils/drawing_utils.js"(exports) {
    (function() {
      ...
      var l = typeof Object.defineProperties == "function" ? Object.defineProperty : function(a, c, b) {
      ...
      function p(a, c) {
        if (c)
          a: {
            ...
            d = b[a];
            c = c(d);
            c != d && c != null && l(b, a, { configurable: true, writable: true, value: c });
          }
      }
      function q(a) {
      ...
      var r = typeof Object.assign == "function" ? Object.assign : function(a, c) {
      ...
      v("drawLandmarks", function(a, c, b) {
        if (c) {
          ...
          for (var f = c.next(); !f.done; f = c.next())
            if (f = f.value, f !== void 0 && (f.visibility === void 0 || f.visibility > b.visibilityMin)) {
      ...
      v("drawConnectors", function(a, c, b, d) {
        if (c && b) {
          ...
          for (var g = b.next(); !g.done; g = b.next()) {
            ...
            g = c[k[0]];
            k = c[k[1]];
            g && k && (g.visibility === void 0 || g.visibility > d.visibilityMin) && (k.visibility === void 0 || k.visibility > d.visibilityMin) && (a.strokeStyle = y(d.color, { index: f, from: g, to: k }), a.lineWidth = y(d.lineWidth, { index: f, from: g, to: k }), a.moveTo(g.x * e.width, g.y * e.height), a.lineTo(k.x * e.width, k.y * e.height));
            ++f;
            a.stroke();
          }
          a.restore();
...
// dep:@mediapipe_drawing_utils
var mediapipe_drawing_utils_default = require_drawing_utils();
export {
  mediapipe_drawing_utils_default as default
};
