...
var require_control_utils = __commonJS({
  "node_modules/@mediapipe/control_utils/control_utils.js"(exports) {
    (function() {
      "use strict";
      function aa(a) {
        var b = 0;
      ...
      t("Symbol.iterator", function(a) {
        ...
        for (var b = "Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array".split(" "), c = 0; c < b.length; c++) {
          var d = r[b[c]];
          typeof d === "function" && typeof d.prototype[a] != "function" && p(d.prototype, a, { configurable: true, writable: true, value: function() {
            return ca(aa(this));
          } });
        }
        return a;
      ...
      var ka = typeof Object.assign == "function" ? Object.assign : function(a, b) {
      ...
      t("Promise", function(a) {
        ...
        b.prototype.F = function(e) {
          ...
          typeof h == "function" ? this.J(h, e) : this.m(e);
        };
        ...
        b.prototype.D = function() {
          ...
          if (typeof k === "undefined")
            return true;
          typeof e === "function" ? e = new e("unhandledrejection", { cancelable: true }) : typeof h === "function" ? e = new h("unhandledrejection", { cancelable: true }) : (e = r.document.createEvent("CustomEvent"), e.initCustomEvent("unhandledrejection", false, true, e));
          e.promise = this;
          e.reason = this.i;
          return k(e);
        };
        ...
        b.prototype.then = function(e, h) {
          function k(m, q) {
            return typeof m == "function" ? function(E) {
              try {
                l(m(E));
              } catch (A) {
                n(A);
        ...
        b.prototype.v = function(e, h) {
          ...
          var l = this;
          this.g == null ? g.h(k) : this.g.push(k);
          this.o = true;
        };
        b.resolve = d;
        b.reject = function(e) {
        ...
        b.all = function(e) {
          ...
          return k.done ? d([]) : new b(function(l, n) {
            ...
            var m = [], q = 0;
            do
              m.push(void 0), q++, d(k.value).v(u(m.length - 1), n), k = h.next();
            while (!k.done);
          });
        };
        return b;
      ...
      t("Array.from", function(a) {
        return a ? a : function(b, c, d) {
          ...
          var f = [], g = typeof Symbol != "undefined" && Symbol.iterator && b[Symbol.iterator];
      ...
      function pa(a, b) {
        ...
        for (var g = {}, e = v(a.options), h = e.next(); !h.done; g = { s: g.s }, h = e.next())
          g.s = h.value, h = void 0, this.options.appendChild(h = R("dropdown-option")), this.i[g.s.value] = h, h.textContent = g.s.name, g.s.prefix && h.prepend(g.s.prefix), h.setAttribute("data-value", g.s.value), h.onclick = function(k) {
            return function() {
              T(c, k.s.value);
            };
          }(g);
      ...
      function qa(a, b) {
        ...
        c && (c.classList.remove("selected"), a.h.textContent = b === void 0 ? "" : b);
      }
      ;
      function U(a) {
        this.g = a;
      ...
      W.prototype.create = function(a, b, c) {
        ...
        g.type = "range";
        b.range ? (g.min = "" + b.range[0], g.max = "" + b.range[1], g.step = b.step === void 0 ? "any" : "" + b.step) : b.discrete && (g.min = "0", g.max = "" + (Object.keys(b.discrete).length - 1), g.step = "1");
        g.oninput = function() {
          sa(d, Number(g.value));
        };
        g.onchange = function() {
        ...
        return L(a, function c() {
          ...
          return I(c, function(k) {
            ...
            for (e = g.next(); !e.done; e = g.next())
              h = e.value, h.label !== "" && h.kind === "videoinput" && f.push({ label: h.label, deviceId: h.deviceId });
            return k.return(f);
          });
        });
      }
      ...
      function Ea(a, b) {
        return L(a, function d() {
          ...
          return I(d, function(g) {
            g.g == 1 ? g = F(g, za(f), 2) : g.g != 3 ? f.g.onSourceChanged ? g = F(g, f.g.onSourceChanged(b.label, b.type), 3) : (g.g = 3, g = void 0) : g = F(g, b.start(), 0);
            return g;
          });
        });
      }
      ...
      function Ha(a, b) {
        a.o = new pa({ options: a.l.map(function(c) {
          var d = void 0;
          c.type === "image" ? d = S("https://fonts.gstatic.com/s/i/googlematerialicons/image/v12/gm_grey-24dp/1x/gm_image_gm_grey_24dp.png") : c.type === "video" && (d = S("https://fonts.gstatic.com/s/i/googlematerialicons/videocam/v12/gm_grey-24dp/1x/gm_videocam_gm_grey_24dp.png"));
          ...
          return L(a, function f() {
            ...
            return I(f, function(n) {
              if ((g = c.files) && 0 < g.length) {
                ...
                if ((m === null || m === void 0 ? void 0 : m.length) !== 2 || !(/^image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp|x-icon)$/i.test(m[1]) || /^video\/(?:mpeg|mp4|ogg|webm|x-matroska|quicktime|x-ms-wmv)$/i.test(m[1]) || /^audio\/(?:3gpp2|3gpp|aac|L16|midi|mp3|mp4|mpeg|oga|ogg|opus|x-m4a|x-matroska|x-wav|wav|webm)$/i.test(m[1])))
                ...
                k = u.toString();
                h === "image" ? (qa(l.o, g[0].name), Da(l, k)) : h === "video" && Ca(l, k);
              }
              n.g = 0;
            });
          });
...
// dep:@mediapipe_control_utils
var mediapipe_control_utils_default = require_control_utils();
export {
  mediapipe_control_utils_default as default
};
//# sourceMappingURL=@mediapipe_control_utils.js.map
